...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 flex flex-row justify-between w-[calc(100vw-40px)] items-start xl:max-w-[2000px] xl:grid xl:grid-cols-8 xl:gap-x-4 xl:mx-auto">
